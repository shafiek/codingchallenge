...
class TransactionParser {
    ...
    /**
     * Parses the txnAsString to a {@link Transaction}.  It assumes that txnAsString is in the
     * correct format.  An improvement to this would be to add quite a bit of error handling.
     *
